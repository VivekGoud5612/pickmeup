...
"""
MUTATABLE RUN TIME STATE, NOT IMMUTABLE LIKE OTHER VALUE OBJECTS....
...
class TrainingProgress:
    ...
    def advance_episode(self) -> "TrainingProgress":   ## Return new objects for each iteration... To make this read more beutifully,....
        self.episode += 1
