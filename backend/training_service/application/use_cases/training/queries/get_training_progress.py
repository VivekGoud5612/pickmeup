...
from backend.training_service.application.dto.training.requests import GetTrainingProgressRequest
from backend.training_service.application.dto.training.responses import TrainingProgressResponse
...
class GetTrainingProgressUseCase:
    ...
    def execute(self, request: GetTrainingProgressRequest) -> TrainingProgressResponse:
